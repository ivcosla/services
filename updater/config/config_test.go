...
func TestServices(t *testing.T) {
	var expectedServiceMaps = map[string]config.ServiceConfig{
		"maria": {
			OfficialName: "maria",
			LocalName: "mariadb",
			UpdateScript:"$HOME/skycoin/github.com/skycoin/services/updater/updater/custom_example/custom_script.sh",
		...
		"sky-node":{
			...
			LocalName: "skycoin",
			UpdateScript:"/Users/ivan/Desktop/skycoin/pkg/github.com/skycoin/services/updater/pkg/updater/scripts/skycoin.sh",
			ScriptInterpreter: "/bin/bash",
			ScriptTimeout: "20m",
