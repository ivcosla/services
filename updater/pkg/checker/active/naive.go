...
import (
	...
	"github.com/skycoin/services/updater/pkg/checker"
)
...
func newNaive(u updater.Updater, service, url string, notifyUrl string, log *logger.Logger) *naive {
	return &naive{
		url:       "github.com" + url,
		exit:      make(chan int),
		updater:   u,
...
func (n *naive) checkIfNew() {
	...
	err := checker.NotifyUpdate(n.notifyUrl, n.service, "master")
